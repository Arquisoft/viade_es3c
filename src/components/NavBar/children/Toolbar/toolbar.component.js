...
const areEqual = (prevProps, nextProps) => {
	const prevInbox = prevProps && prevProps.toolbar.length > 1 && prevProps.toolbar[1].component().props.inbox;
	const nextInbox = nextProps && nextProps.toolbar.length > 1 && nextProps.toolbar[1].component().props.inbox;
