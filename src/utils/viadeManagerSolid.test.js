...
describe.only("viadeManager", () => {
	test("manager", async () => {
		expect(Manager.addMedia(null, "https://saragg.solid.community/profile/card#me")).toMatchObject(
			storageHelper.addMedia("https://saragg.solid.community/profile/card#me", null)
		);
