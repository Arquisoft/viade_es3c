...
describe.only("Ldflex", () => {
  ...
  test('the fetch fails with an error', () => {
    ...
    return ldflex.createDocumentWithTurtle("prueba", null).catch(e => expect(e).toMatch('error'));
    return ldflex.getLinkedInbox("prueba").catch(e => expect(e).toMatch('error'));
    return ldflex.resourceExists("prueba").catch(e => expect(e).toMatch( Toaster.errorToaster(e.message, "Error")));
