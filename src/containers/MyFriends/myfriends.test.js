...
describe.only("MyFriends", () => {
  ...
  test("functions", () => {
    expect(
      friends.getUserName("https://saragg.solid.community/profile/card#me/")
    ).toBe("saragg/");
    expect(
      friends.getUrl("https://saragg.solid.community/profile/card#me")
    ).toBe("https://saragg.solid.community/");
  });
